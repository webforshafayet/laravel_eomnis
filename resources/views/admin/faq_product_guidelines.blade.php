...
<div class="main-content">
    ...
    <div class="container-fluid"  >
        ...
        <h1 style="Padding: top 25px;font-size:25px">FAQ Product Guidelines</h1>
...
<form action="{{url('upload_faq_product_guidelines')}}" method="post" enctype="multipart/form-data"> 
@csrf
        <div class="mb-3">
