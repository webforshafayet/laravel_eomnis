                    ...
                    <div class="card h-100 rounded-0">
                        ...
                        <!-- nubering-------------------------------------------------------------------------------------- -->
                            ...
                            <div class="card-text d-flex justify-content-between align-items-center mt-5">
                                ...
                                <!-- <a href=" {{url('seller_add_watchlist',$data->id)}}" class="btn btn-dark px-4">Add To Watchlist</a> -->
                                

                                <div>
                                    <a href=" {{url('seller_product_checkout',$data->id)}}" class="btn btn-dark px-4">Select</a>
