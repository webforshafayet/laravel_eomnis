                ...
                <div class="py-4">
                    ...
                    <div class="py-2">
                        ...
                        <div class="mb-2">
                         ...
                         <!-- Side Item Selling -->
                         <div class="mb-2">
                            <a href="{{url('seller_selling')}}">
                                <div class="px-4 d-flex align-items-center side-item">
                                    <div class="me-4">
                                        <img src="images/selling-white.svg" class="white-icon" alt="selling">
                                        <img src="images/selling-black.svg" class="black-icon" alt="selling">
                                    </div>
                                    <div class="pt-3">
                                        <p class="side-item-title-1 mb-1">Active items listed, Items Sold</p>
                                        <p class="side-item-title-2 mb-0">Active Asks, In-Progress,</p>
                                        <p class="side-item-title-2">
                                            Completed Sales</p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <!-- Side Item Settings -->
                        <div class="mb-2">
                            <a href="{{url('seller_profile_setting')}}">
                                <div class="px-4 d-flex align-items-center side-item">
                                    <div class="me-4">
