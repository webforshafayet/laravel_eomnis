                    ...
                    <div class="card h-100 rounded-0">
                        ...
                        <div>
                            <div class="mt-5 d-flex">
                                <a href="{{url('seller_product_details',$data->id)}}" class="btn border w-100 rounded-0">Cancel</a>
                                <a href="{{url('seller_checkout',$data->id)}}" class="btn btn-dark w-100 rounded-0">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
