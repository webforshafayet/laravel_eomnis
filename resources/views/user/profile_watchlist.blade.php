    ...
    <main>
        ...
        <div class="row m-0">
            ...
            <div class="col-12 col-sm-12 col-md-9 light-bg">
             ...
             @foreach($watchlist as $product)
                        <tbody>
                            <tr>
                                <td class="hide">
                                    <div
                                        class="d-flex flex-row flex-sm-column flex-md-row  justify-content-start align-items-center">
                                        <img class="img-fluid" src="/productimage/{{$product->image}}"  style="height:70px; width:70px;"  alt="shoe">

                                        

                                        <div class="ms-3">
                                            <p class="table-title-1 mb-2">{{$product->tittle}}</p>
                                            <p class="table-title-2 mb-2">{{$product->description}}</p>
                                            <p class="table-title-3">AUS M Mens Size: {{$product->size}}</p>
                                        </div>
                                    </div>
                                </td>
                                <td>{{$product->price}}</td>
                                <td class="hide">
                                   <a href="{{ url('watchlist_delete/'.$product->id)}}"><img class="img-fluid" src="images/delete.svg" alt="delete"></a>
